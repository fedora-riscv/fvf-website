...
import { teamMembers, websites, newsList, teamIntro, partners, sponsors } from "@/lib/data"
        ...
        {/* <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-col gap-16 max-w-4xl mx-auto">
              {sponsors.map((sponsorList, index) => (
                <div key={index} className="flex flex-wrap justify-center items-center gap-24">
                  {sponsorList.map((sponsor) => (
                    <div key={sponsor.name} className="flex-shrink-0 w-full sm:w-auto">
                      <a
                        href={sponsor.link}
                        target="_blank"
